...
- Companion (llm-functions repo, branch `feat/tool-safety-permission-boundary`): `734a376` — feat: expose permissions contract in orchestrator schema
